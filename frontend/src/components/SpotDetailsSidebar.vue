<template>
  ...
  >
    ...
    >
      <div class="flex items-center">
        ...
        <div class="flex flex-col items-center mr-4">
          ...
          <span class="font-semibold text-gray-900 dark:text-white">{{ spot.score }}</span>
          <button
            :disabled="!authStore.isAuthenticated"
            @click="() => handleVote(-1)"
            class="focus:outline-none"
        ...
        <!-- Spot title -->
        <div class="flex items-center">
          <div class="w-12 h-12 bg-gray-200 dark:bg-gray-600 rounded mr-3 flex-shrink-0"></div>
    ...
    <div class="p-4 flex-1 overflow-y-auto">
      ...
      <p
        v-else
        class="mb-4 text-gray-400 dark:text-gray-500 italic"
      >
