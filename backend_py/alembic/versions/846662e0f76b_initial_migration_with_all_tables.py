...
Revision ID: 846662e0f76b
Revises: 
Create Date: 2025-06-28 21:29:49.061612
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('short_id', sa.String(length=6), nullable=False),
    ...
    op.create_index(op.f('ix_spots_short_id'), 'spots', ['short_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_spots_short_id'), table_name='spots')
